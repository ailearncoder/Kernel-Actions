...
echo
git clone --depth=1 https://github.com/LineageOS/android_kernel_xiaomi_msm8996.git kernel
...
mkdir -p out
export ZIPNAME=msm8996-Kernel.zip
export ARCH=arm64
...
cp msm8996-docker_defconfig kernel/arch/arm64/configs/
...
echo "Set DEFCONFIG"
echo 
make CC=clang O=out msm8996-docker_defconfig
